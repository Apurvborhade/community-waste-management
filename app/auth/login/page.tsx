      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-background text-muted-foreground">New to EnvironmentTech?</span>
          </div>
        </div>

        <Link href="/auth/sign-up" className="block text-center text-primary hover:underline text-sm font-medium">
